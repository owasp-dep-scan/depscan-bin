...
On Linux
```
curl -LO https://github.com/appthreat/depscan-bin/releases/download/v4.0.0/depscan-linux-amd64
...
```
curl -LO https://github.com/appthreat/depscan-bin/releases/download/v4.0.0/depscan.exe
.\depscan.exe --help
```
